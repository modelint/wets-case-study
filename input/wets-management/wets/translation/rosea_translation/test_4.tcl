# 4.    Transfer request to go "down" when the only available transfers are for "up".
#       Expect an instance of Assigned Vessel to be created, the water is adjusted to
#       make a transit lane be available for a down transfer. The transfer completes
#       after the water adjustments are made.
namespace eval test_4 {
    set service [string trimleft [namespace parent] :]::test_4
    ...
    proc setup {test_case configuration test_phase} {
        ...
        # Leave this phase as a place holder
    }
